...
{
    $output.='
              <font size="+2"><b>प्रशिक्षकको लागि प्राप्त आवेदनहरु - जील्ला :-'. $_SESSION['district']. ' पालिका :-'. $_SESSION['palika'] . ' शैक्षिक सत्र:-' . $_SESSION['eduyear'] .' </b></font>
   ...
   $schooldistrict="";
            ...
            WHERE tt.teacherdistrict = '".$_SESSION['district']."' and tt.munid='".$_SESSION['munid']."' and SUBSTRING(tt.sdate,1,4)='".$_SESSION['eduyear']."'
   ...
   header("Content-Type: application/xls");
	header("Content-Disposition: attachment; filename=teacher_details_districtpalika.xls");
    echo $output;
 }
?>
</BODY>
