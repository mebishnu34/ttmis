...
{
    $output.='
              <font size="+2"><b>प्रशिक्षकको लागि प्राप्त आवेदनहरु - विषय :-'. $_SESSION['subject'] . ' शैक्षिक सत्र:-' . $_SESSION['eduyear'] .' </b></font>
   ...
   $schooldistrict="";
            ...
            $i = 1;
        $sql4 = "SELECT trainingid FROM tblruntraining where subject='".$_SESSION['subject']."'";
...
if ($result4->num_rows > 0)
   ...
   header("Content-Type: application/xls");
	header("Content-Disposition: attachment; filename=teacher_details_subject.xls");
    echo $output;
 }
?>
</BODY>
