...
if(isset($_POST["teacherdistrict"]))
{
   ...
   $schooldistrict="";
            ...
            WHERE tt.teacherdistrict = '".$_SESSION['district']."' and SUBSTRING(tt.sdate,1,4)='".$_SESSION['eduyear']."'
   ...
   header("Content-Type: application/xls");
	header("Content-Disposition: attachment; filename=teacher_details_district.xls");
    echo $output;
 }
?>
</BODY>
