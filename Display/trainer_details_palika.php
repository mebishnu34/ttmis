...
$_SESSION['palika']=$palika;
$_SESSION['eduyear']=$eduyear;

$sql4 = "SELECT ID FROM tbldistrict where munvdc='".$palika."'";
...
<form method="post" action="../export/export_teacherdetails_palika.php">
<div id="pdata">
      <font size="+2"><b>प्रशिक्षकको लागि प्राप्त आवेदनहरु - जील्ला :- <?php echo $district;?>,पालिका :- <?php echo $palika;?>, शैक्षिक सत्र:- <?php echo $eduyear;?></b></font>
...
WHERE tt.teacherdistrict = '".$district."' and tt.munid='".$munid."' and SUBSTRING(tt.sdate,1,4)='".$eduyear."'
ORDER BY tt.trainingid
";
