...
if($d<>"")
	 {
        $Query = "SELECT DISTINCT tcode FROM tbltpd where tsubject='$d' ORDER BY tname";
        ...
        $sn++;
        $QueryM1 = "SELECT * FROM tbltpd where tsubject='$d' and tcode='$teachercode' and tpdstep='M1'";
        ...
        $QueryM2 = "SELECT * FROM tbltpd where tsubject='$d' and tcode='$teachercode' and tpdstep='M2'";
        ...
        $QueryM3 = "SELECT * FROM tbltpd where tsubject='$d' and tcode='$teachercode' and tpdstep='M3'";
        ...
        $totalobtmark=0;
        $QueryP1 = "SELECT regularatten, creative, written, planning,trainingdate, closingdate, fyear, trainingvenue, facilitator,remark FROM tbltpd where tsubject='$d' and tcode='$teachercode' and tpdstep='P1'";
        ...
        $totalobtmarkp2=0;
        $QueryP2 = "SELECT regularatten, creative, written, planning,trainingdate, closingdate, fyear, trainingvenue, facilitator,remark FROM tbltpd where tsubject='$d' and tcode='$teachercode' and tpdstep='P2'";
