...
<div id="pdata">
      <font size="+2"><b>प्रशिक्षकको लागि प्राप्त आवेदनहरु - िवषय :- <?php echo $subject;?>, शैक्षिक सत्र:- <?php echo $eduyear;?></b></font>
...
$oldcategory="";
$i = 1;
$sql4 = "SELECT trainingid FROM tblruntraining where subject='".$subject."'";
