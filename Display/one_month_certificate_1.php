...
<center><font size="+1" color="blue"><b><font size="6" color="blue">एक महिने प्रमाणीकरण तालिम</font></b></font></center>
 ...
 <br>
     <div align="justify" style="line-height: 2;">
        <font size="5">
            श्री को <?php echo $fathername;?> छोरा/छोरी  <?php echo $province;?> प्रदेश <?php echo $district;?> जिल्ला <?php echo $munvdc;?> म.न.पा।/उ.म.न.पा./न.पा./गा.पा. वडा नं. <?php echo $wardno;?> स्थायी ठेगाना एवम् नागरिकता प्रमाणपत्र नं.<?php echo $citizenshipno;?> भएको श्री <?php echo $teachername;?> ले <?php echo $traingyear;?> सालमा <?php echo $training;?> को एक महिने प्रमाणीकरण तालिम (३० कार्यदिन) सम्पन्न गर्नु भएकाले यो प्रमाण पत्र प्रदान गरिएको छ ।
        </font>    
    </div>
<br>
<br>
