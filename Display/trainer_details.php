...
<form method="post" action="../export/export_teacherdetails_district.php">
<div id="pdata">
      <font size="+2"><b>प्रशिक्षकको लागि प्राप्त आवेदनहरु - जील्ला :- <?php echo $district;?>, शैक्षिक सत्र:- <?php echo $eduyear;?></b></font>
...
WHERE tt.teacherdistrict = '".$district."' and SUBSTRING(tt.sdate,1,4)='".$eduyear."'
