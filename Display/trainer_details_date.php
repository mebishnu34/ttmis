...
$syear=substr($datefrom,0,4);
$_SESSION['syear']=$syear;
$smonth=substr($datefrom,5,2);
$_SESSION['smonth']=$smonth;
$sday=substr($datefrom,8,2);
$_SESSION['sday']=$sday;
$dateto=$_POST['txtdateto'];
$eyear=substr($dateto,0,4);
$_SESSION['eyear']=$eyear;
$emonth=substr($dateto,5,2);
$_SESSION['emonth']=$emonth;
$eday=substr($dateto,8,2);
$_SESSION['eday']=$eday;
?>
<?php
...
<form method="post" action="../export/export_teacherdetails_subject.php">
<div id="pdata">
      <font size="+2"><b>प्रशिक्षकको लागि प्राप्त आवेदनहरु - िमति :- <?php echo $datefrom;?>, देखि:- <?php echo $dateto;?></b></font>
...
WHERE tt.sdate BETWEEN '".$syear."-".$smonth."-".$sday."' 
