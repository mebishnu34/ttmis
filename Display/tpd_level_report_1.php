...
//echo $step;
$sn=1;
if($step<>"" and $sub<>"" and $level<>"")
	 {
        $Query = "SELECT DISTINCT tcode FROM tbltpd where trainingstep='$step' and teacherlevel='$level' and tsubject='$sub' ORDER BY tname";
        ...
        $Query1 = "SELECT tname, teacherlevel, schoolname, logov, district FROM tbltpd where tcode='$teachercode' and trainingstep='$step' and teacherlevel='$level' and tsubject='$sub'";
