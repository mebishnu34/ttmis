...
<tr>
<td colspan="6" align="center"><b>Teacher Summery</b></td>
</tr>
<tr>
...
$tteacher=0;
	...
	$sql1 = "SELECT count(teachercode) FROM tblteacher where district='भक्तपुर' and gender<>'महिला'  and gender<>'पुरूष'";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0)
      {
      while($row = $result1->fetch_assoc())
	...
	if ($result1->num_rows > 0)
      ...
      while($row = $result1->fetch_assoc())
		...
		$sql1 = "SELECT count(teachercode) FROM tblteacher where district='चितवन' and gender<>'महिला'  and gender<>'पुरूष'";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0)
      {
      while($row = $result1->fetch_assoc())
	...
	if ($result1->num_rows > 0)
      ...
      while($row = $result1->fetch_assoc())
		...
		$sql1 = "SELECT count(teachercode) FROM tblteacher where district='धादिंग' and gender<>'महिला'  and gender<>'पुरूष'";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0)
      {
      while($row = $result1->fetch_assoc())
	...
	if ($result1->num_rows > 0)
      ...
      while($row = $result1->fetch_assoc())
		...
		$sql1 = "SELECT count(teachercode) FROM tblteacher where district='दोलखा' and gender<>'महिला'  and gender<>'पुरूष'";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0)
      {
      while($row = $result1->fetch_assoc())
	...
	if ($result1->num_rows > 0)
      ...
      while($row = $result1->fetch_assoc())
		...
		$sql1 = "SELECT count(teachercode) FROM tblteacher where district='काठमाण्डौ' and gender<>'महिला'  and gender<>'पुरूष'";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0)
      {
      while($row = $result1->fetch_assoc())
	...
	if ($result1->num_rows > 0)
      ...
      while($row = $result1->fetch_assoc())
		...
		$sql1 = "SELECT count(teachercode) FROM tblteacher where district='काभ्रेपलाञ्चोक'and gender<>'महिला'  and gender<>'पुरूष'";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0)
      {
      while($row = $result1->fetch_assoc())
	...
	if ($result1->num_rows > 0)
      ...
      while($row = $result1->fetch_assoc())
		...
		$sql1 = "SELECT count(teachercode) FROM tblteacher where district='ललितपुर' and gender<>'महिला'  and gender<>'पुरूष'";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0)
      {
      while($row = $result1->fetch_assoc())
	...
	if ($result1->num_rows > 0)
      ...
      while($row = $result1->fetch_assoc())
		...
		$sql1 = "SELECT count(teachercode) FROM tblteacher where district='मकवानपुर' and gender<>'महिला'  and gender<>'पुरूष'";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0)
      {
      while($row = $result1->fetch_assoc())
	...
	if ($result1->num_rows > 0)
      ...
      while($row = $result1->fetch_assoc())
		...
		$sql1 = "SELECT count(teachercode) FROM tblteacher where district='नुवाकोट' and gender<>'महिला'  and gender<>'पुरूष'";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0)
      {
      while($row = $result1->fetch_assoc())
	...
	if ($result1->num_rows > 0)
      ...
      while($row = $result1->fetch_assoc())
		...
		$sql1 = "SELECT count(teachercode) FROM tblteacher where district='रामेछाप'and gender<>'महिला'  and gender<>'पुरूष'";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0)
      {
      while($row = $result1->fetch_assoc())
	...
	if ($result1->num_rows > 0)
      ...
      while($row = $result1->fetch_assoc())
		...
		$sql1 = "SELECT count(teachercode) FROM tblteacher where district='रसुवा'  and gender<>'महिला'  and gender<>'पुरूष'";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0)
      {
      while($row = $result1->fetch_assoc())
	...
	if ($result1->num_rows > 0)
      ...
      while($row = $result1->fetch_assoc())
		...
		$sql1 = "SELECT count(teachercode) FROM tblteacher where district='सिन्धुली' and gender<>'महिला'  and gender<>'पुरूष'";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0)
      {
      while($row = $result1->fetch_assoc())
	...
	if ($result1->num_rows > 0)
      ...
      while($row = $result1->fetch_assoc())
		...
		$sql1 = "SELECT count(teachercode) FROM tblteacher where district='सिन्धुपाल्चोक' and gender<>'महिला'  and gender<>'पुरूष'";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0)
      {
      while($row = $result1->fetch_assoc())
