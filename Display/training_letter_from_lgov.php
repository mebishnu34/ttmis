...
if(isset($_GET['mid']))
	...
	if ($result1->num_rows > 0)
		...
		$ldate="";
		$munvdc="";
	$sql2="SELECT msgnumber, ldate,munvdc from tblmuncipalityinfo where msgnumber='$msgno'";
	...
	$authorize="";
	$mobile="";
	$sqlm="SELECT districtname,aperson,mobileno from tbldistrict where munvdc='$munvdc'";
    ...
    if ($resultm->num_rows > 0)
    {
        if($rowm = $resultm->fetch_assoc())
        {
		 ...
		 $authorize=$rowm["aperson"];
		 $mobile=$rowm["mobileno"];
        }
    }
   	?>
<HTML>
...
<font size="6"><?php echo $munvdc;?></font><br>
<font  size="4"><?php echo $district;?></font><br>
</td>
...
<tr>
<td align="Left" colspan="3"><font size="3">इ‍.च.नं. <?php echo $msgno;?></font></td>
</tr>
<tr>
...
<?php
	$sn=1;
	$sql="SELECT schoolcode,munvdc,trainingid,teacherid,msgnumber, pnumber,ondate,ldate, remark FROM tblmuncipalityinfo where msgnumber='$msgno'";
...
<br><br><br>
<div align="right">
<font size="4"><b><?php echo $authorize;?> </b></font><br>
<font size="4"><b><?php echo  $mobile;?> </b></font>
</div>
