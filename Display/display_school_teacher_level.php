...
<tr>
    <td bgcolor="#0000FF" align="Right"><font color="#FFFFFF"><a href="../Admin/admin_application.php">Home</a></font></td>
...
<div id="pdata">
 ...
 <tr>
 <td colspan="9" align="center"><font size="+2"><b>District:<?php echo $district;?> &nbsp;&nbsp;&nbsp; Local Government:<?php echo $mun;?> &nbsp;&nbsp;&nbsp; Name of Level:<?php echo $level;?> </b></font></td>
 </tr>
<tr>
<td>S.No</td>
<td>Teacher Code</td>
...
if($mun=="All")
{
      $sql1 = "SELECT * FROM tblteacher where workinglevel='$level' and district='$district'";
      $result1 = $conn->query($sql1);
}
else
{
      $sql1 = "SELECT * FROM tblteacher where workinglevel='$level' and munvdc='$mun' and district='$district'";
      $result1 = $conn->query($sql1);
}
