...
?>
<BODY>
<form method="Post" Action="../Input/school_code.php">
    ...
    <td><div id="txtHint">Subject</div>
           ...
           <tr>
               ...
               <td><input type="text" name="txtvenu" size="60"></td>
           </tr>
                <tr>
    <td align="right">Group Number</td>
    <td><select name="cmbgnumber">
        <option>1</option>
         <option>2</option>
         <option>3</option>
         <option>4</option>
    ...
    <tr>
               ...
               <td><input type="text" name="txtcoordinator"></td>
           </tr>
    <tr>
           ...
           <tr>
               <td colspan="2" align="center"><input type="submit" value="Display" name="btndisplay" class="button">&nbsp;&nbsp;<input type="submit" value="Add Teacher" name="btnteacher" class="button">&nbsp;&nbsp;<input type="submit" value="Add Other" name="btnother" class="button"></td>
           </tr>
    </table>
</form>
</BODY>
