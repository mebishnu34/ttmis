...
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
   ...
   <script type="text/javascript" src="../script/name_searchmobile.js"></script>
...
<td bgcolor="#0000FF"><font color="#FFFFFF" size="2"><div align="right"><?php echo $_SESSION['uname'];?></div></font></td>
  ...
  <form action="../Object/Save_teacher_participate_in_training_1.php" method="Post">
  <table width="100%">
  <tr>
    <td bgcolor="blue"><a href="../Admin/registration.php?linkid=14" target="_blank">New Teacher</a></td>
  <tr>
    <td valign="top">
<input type="text" id="search" placeholder="Search BY Mobile Number" />
  <div id="display"></div>
   </td>
