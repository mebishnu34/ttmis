...
function district1(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","Admin/dropdistrict_1.php?q="+str,true);
        xmlhttp.send();
    }
}
function schoolmun(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","Admin/dropschool.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"></head>
 ...
 <form action="common_display/display_school_teacher_subject.php" method="Post">
  <table>
