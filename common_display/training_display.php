...
<BODY>
    <form method="Post" Action="common_display/subject_training.php" target="_blank">
...
<tr>
    <td colspan="2" align="center"><input type="submit" name="btnsave" value="Display" ></td>
    </tr>
    </table>
    </form>
</BODY>
