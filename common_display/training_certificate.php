...
$sql = "SELECT * FROM tblruntraining where remark='Completed' ORDER BY id";
...
if ($result->num_rows > 0)
   {
    while($row = $result->fetch_assoc())
    {
         ...
         echo "<td align=center><a href=common_display/teacher_training_certificate.php?tid=$row[trainingid] target=_blank>Certificate</a></td>";
         echo "</tr>";
         $sn++;
    }
}
