...
<tr>
<td colspan="0" bgcolor="#0852FA" align="Right"><a href="../common_report.php">Home</a></td>
 ...
 <?php
  if ($result->num_rows > 0)
    ...
    <tr>
      ...
      <td align="Left"><a href="../common_display/download.php?school_id=<?php echo $row['ID']; ?>" target=_blank>Download</a></td>
    </tr>
  <?php
       $sn=$sn+1;
       }
