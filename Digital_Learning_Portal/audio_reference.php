...
<body class="content">
    ...
    <div class="details_row">
         ...
         <div style="background-color:chocolate;font-weight: 900;">
            ...
            <ul id="userhyperlink">
                <li><a href="subject_audio_reference.php?subject_id=TPD">Teacher Professional Development</a></li>
                <li><a href="subject_audio_reference.php?subject_id=ROT">Resources of Teaching</a></li>
                <li><a href="subject_audio_reference.php?subject_id=SLR">Student Learning Resources</a></li>
            </ul>
        ...
        <div class="user_details_row3">
            ...
            <div id="category">
                <a href="subject_audio_reference.php?subject_id=TPD"><img src="digital_image\classroom_training.jpg" width="100" height="100"><br><br>Teacheer Professional Development
                
                </a><br>
            </div>
            
            <div id="category">
                  <a href="subject_audio_reference.php?subject_id=ROT" target="blank"><img src="digital_image\technology.jpeg" width="180" height="100"><br><br>Resources of Teaching
                  
                  </a>
            </div>
            
            <div id="category">
               <a href="subject_audio_reference.php?subject_id=SLR" target="blank"><img src="digital_image\exploring_creativity.jpg" width="180" height="100">
