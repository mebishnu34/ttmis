                    ...
                    <div class="sub_row">
                        ...
                        <nav class="navigation">   
                            <ul>
                                ...
                                <li><a href="user_application.php?user=userout">Sign Out</a></li>
                            </ul>
                        </nav>
                        </div>
                    </div>
    ...
    <div class="details_row">
         <div class="user_list_column_1">
            ...
            <header class="user_header_list">   
                <ul id="userhyperlink">
                <li><a href="read_contents.php?subject_id=TPD">Teacher Professional Development</a></li>
                <li><a href="read_contents.php?subject_id=ROT">Resources of Teaching</a></li>
                <li><a href="read_contents.php?subject_id=SLR">Student Learning Resources</a></li>
                </ul>
            </header>
        </div>
        <div class="user_details_column_1">
            ...
            <div id="category">
                <a href="read_contents.php?subject_id=TPD"><img src="digital_image\classroom_training.jpg" width="100" height="100"><br><br>Teacheer Professional Development
                
                </a><br>
            </div>
            
            <div id="category">
                  <a href="read_contents.php?subject_id=ROT" target="blank"><img src="digital_image\technology.jpeg" width="180" height="100"><br><br>Resources of Teaching
                  
                  </a>
            </div>
            
            <div id="category">
               <a href="read_contents.php?subject_id=SLR" target="blank"><img src="digital_image\exploring_creativity.jpg" width="180" height="100">
