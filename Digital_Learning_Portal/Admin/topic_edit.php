...
$id=$_GET['topid'];
$sql="Select id, content_topic from tbltopic where id='$id'";
$result=$conn->query($sql);
if($data=$result->fetch_assoc())
{
$id= $data["id"];
$subject= $data["content_topic"];
}
?>
...
<body>
<form action="processing/update_topic.php" method="post" ID="normal_form">
...
<tr>
<td>Topic</td>
<td><input type="text" name="txttopic" value="<?php echo $subject;?>"></td>
</tr>
<tr>
