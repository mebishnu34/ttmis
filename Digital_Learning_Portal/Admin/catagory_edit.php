...
$id=$_GET['subid'];
$sql="Select id, categoryname from tbl_catagory where id='$id'";
$result=$conn->query($sql);
if($data=$result->fetch_assoc())
{
$id= $data["id"];
$subject= $data["categoryname"];
}
?>
...
<body>
<form action="processing/update_catagory.php" method="post" ID="normal_form">
...
<tr>
<td>Catagory</td>
<td><input type="text" name="txtcatagory" value="<?php echo $subject;?>"></td>
</tr>
<tr>
