            ...
            <div class="droplist">
                <li>Teacher Professional Development</li>
                    <ul class="list-categories">
                        <li><a href="user_application.php?topic_id=essay">Eassy</a></li>
                        <li><a href="#">Story</a></li>
                        <li><a href="#">Grammar</a></li>
                        <li><a href="#">News</a></li>
                    </ul>
                </div>
                <div class="droplist"><li>Resources of Teaching</li>
                    <ul class="list-categories">
                        <li><a href="#">Nibanda</a></li>
                        <li><a href="#">Loka Katha</a></li>
                        <li><a href="#">Byakaran</a></li>
                        <li><a href="#">Kabita</a></li>
                    </ul>
                </div> 
                <div class="droplist"><li>Student Learning Resources</li>
                    <ul class="list-categories">
                        <li><a href="#">Nibanda</a></li>
                        <li><a href="#">Loka Katha</a></li>
                        <li><a href="#">Byakaran</a></li>
        ...
        <div class="user_details_column">
            ...
            if(isset($_GET['topic_id']))
                ...
                <div class="mySlides fade">
                    ...
                    <img src="image\tpd.jpg" height="400px" style="width:100%;" id="#slideimage">
                    <div class="text">TPD</div>
                </div>
                <div class="mySlides fade">
                    <div class="numbertext">2 / 3</div>
                    <img src="image\teaching_resource.jpg" height="400px" style="width:100%;" id="#slideimage">
                    <div class="text">Teaching Resource</div>
                </div>
                <div class="mySlides fade">
                    <div class="numbertext">3 / 3</div>
                    <img src="image\tpd.jpg" height="400px" style="width:100%;" id="#slideimage">
                    <div class="text">Student Learning</div>
                </div>
                ...
                <script src="script\slider_script.js"></script>
                    <?php
                    }
                    elseif($topic=='essay')
                    {
