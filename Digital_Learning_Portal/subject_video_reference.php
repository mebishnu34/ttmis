    ...
    <div class="details_row">
         ...
         <div style="background-color:chocolate;font-weight: 900;">
            ...
            <?php
                    ...
                    ?>
                        ...
                        <ul class="list-categories">
                            ...
                            while($topicdata=$topicresult->fetch_assoc())
		                        {
			                     echo "<li><a href=subject_video_reference.php?topic_id=". $topicdata["id"] .">". $topicdata["content_topic"]."</a></li>";
                                }
                            ?>
                        </ul>
                <?php
                ...
                <div class="droplist">
                    <?php
                    $sql="Select subjectid, subject from tbl_subject ORDER BY subject";
                    $result=$conn->query($sql);
                    while($data=$result->fetch_assoc())
                        {
                        $id=$data["subjectid"];
