...
<tr>
<td valign="buttom" align="center" bgcolor="#FFFFFF"><img src="../municipality/../Image/logo.jpg" width="150" height="130"></td>
<td  valign="top" bgcolor="#FFFFFF"><img src="../municipality/../Image/banner.jpg" height="130"></td>
<td valign="buttom" align="center" bgcolor="#FFFFFF"><img src="../municipality/../Image/np_flag.gif" width="150" height="130"></td>
</tr
><tr>
...
?>
<form method="POST" Action="../Object/change_teacher_school.php">
...
<tr>
<td colspan="3" align="center"><input name="btnsave" type="Submit" value="Add In School" class="button"></td>
</tr>
</table>
</form>
<?php
