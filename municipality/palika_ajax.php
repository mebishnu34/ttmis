...
//Search query.
   ...
   $Query = "SELECT teachercode, tname, tcontact,schoolname,munvdc,district FROM tblteacher WHERE munvdc='$_SESSION[uname]' and  tname LIKE '$Name%' LIMIT 100";
//Query execution
...
<td onclick='fill("<?php echo $Result['teachercode']; ?>")'><?php echo $Result['schoolname']; ?></td>
