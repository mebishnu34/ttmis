...
$sql1 = "SELECT * from tblmuncipalityinfo where trainingid='$_SESSION[trainingid]' and munvdc='$_SESSION[uname]' and remark='Request'";
$res = $conn->query($sql1);
 ?>
</HEAD>
<BODY class="bg">
...
if ($res->num_rows > 0)
   {
    ...
    $sql="SELECT teachercode, scode, tname, tcontact,email FROM tblteacher where teacherid='$teacherid'";
