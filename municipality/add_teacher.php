...
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
   ...
   <script type="text/javascript" src="../script/teacher_search.js"></script>
...
<tr>
    <td bgcolor="#0000FF" align="Right"><font color="#FFFFFF"><a href="../Input/../admin_login.php">Log Off</a></font></td>
...
<td bgcolor="#0000FF"><font color="#FFFFFF" size="2"><div align="right"><?php echo $_SESSION['uname'];?></div></font></td>
  ...
  <form action="../Object/Save_palikateacher_in_training.php" method="Post">
  <table width="100%">
  <tr>
    <td valign="top">
