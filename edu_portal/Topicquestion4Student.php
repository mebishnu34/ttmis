...
include("include/topicexamquestion.php");
?>
...
<tr>
<td align="left" width="400"><a href="member_exam.php"><img src="image/banner.jpg" width="400" height="100"></a></td>
<td align="left"><?php echo '<img src="data:image/jpeg;base64,' . base64_encode($_SESSION['content']) . '" width="100" height="100">';?></td>
</tr>
</table>
<form method="post" action="php/SaveTopicResult.php">
<table width="800" border="0" align="center">
<tr>
<td align="left" width="100" colspan="2" bgcolor="#00FFFF">Subject :- <?php echo $_SESSION['tsubject']; ?> &nbsp; <a href="member_exam.php">Back</a></td>
</tr>
<tr>
<td align="right">Full Mark:-100</td>
<td align="right"></td>
</tr>
<tr>
