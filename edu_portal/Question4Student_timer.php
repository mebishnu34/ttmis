...
if(isset($_SESSION['memlname']))
	{
		...
		$ans3="";
		$ans4="";
		/* // check previous mark or exam
$dsql="Select * from tblmarkdetails where memid='$_SESSION[memberid]' and subject='$_SESSION[subject]'";
		$dresult=$conn->query($dsql);
		if($dresult->num_rows>0)
		{
		 header('Location: Examhall.php?msg="Sorry,You have already given."');
		}
	*/  
/*
	if($_SESSION['exam']=="Final Exam")
	{	
	$data="Select id, question, subjectid, ordering, ans1, ans2, ans3, ans4, correctno from tblquestions where subjectid='$subid' and classname='$_SESSION[class]'";
	$result = mysqli_query($conn,$data);
	}
	else
	{
	$data="Select id, question, subjectid, ordering, ans1, ans2, ans3, ans4, correctno from tblquestions where subjectid='$subid' and examid='$examid' and classname='$_SESSION[class]'";
	$result = mysqli_query($conn,$data);
*/
$sql1="Select questionid, question, subject, ordering, ans1, ans2, ans3, ans4, correctno from tblquestion where subject='$_SESSION[subject]' and level='$_SESSION[level]'";
	...
	if($result->num_rows>0)
	    {
	        while($row =$result->fetch_assoc())
	        {
	           // echo $row["question"];
		        ...
		        $ans[$k]=$row["correctno"];
		        //$test[$k]="Nepal";
		       // echo "<br> Questions:-". $questions[$k];
          //echo "<br> Hello-". $test[$k];
	            //echo $k;
		        $k++;
	        }
	    }
...
?>
<script language="javascript" src="script/timer.js"></script>
<form name="quiz" id="myquiz" onSubmit="return validate()" method="post" action="php/SaveResult_timer.php">
<table width="100%" border="0" align="center">
<tr>
<td align="left"><canvas id="canvas" width="150" height="150"
style="background-color:#FFFFCC">
</canvas>
<script src="script/clock.js"></script>
</td>
<td align="left"><font size="+3" color="#000066"><b>Online Test</b></font></td>
</tr>
<tr>
<td align="left"><div id="status"></div>
            <script type="text/javascript">countDown(60,"status");</script>
             </td>
			 <td>&nbsp;</td>
</tr>
<tr>
<td align="left" colspan="2" bgcolor="#FFFFFF">Name :- <?php echo $_SESSION['fname']; ?> &nbsp;&nbsp;&nbsp; Class : <?php echo $_SESSION['level'];?></td>
</tr>
<tr>
<td align="left">Name Subject :- <?php echo $_SESSION['subject']; ?></td>
<td align="right">Full Mark:-<?php echo $mark;?></td>
</tr>
<tr>
...
<td align="center">
<?php
	echo "<font size=+2 face=Arial>" .$sn.")". "</font>";
?>
</td>
<td>
<?php
...
<tr>
<td align="center" colspan="2"><input type="submit" name="sbmt" value="Submit" ></td>
</tr>
<tr>
<td colspan="2">
<?php
