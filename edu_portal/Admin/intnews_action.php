...
$sql=mysql_query("select newsid, newstitle, news, image,source from tblsocialnews where newsid='$id'",$con);
...
<body>
<form action="../php/update_intnews.php" method="post" enctype="multipart/form-data">
