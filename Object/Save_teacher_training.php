...
if ($result->num_rows > 0)
  ...
  {
     $sql = "INSERT INTO tblttraining(teacherid, trainingid, trainingnumber, remark, category,ongoing) values('$tid', '$traid', '$tn', '$r','Teacher','ON')";
      if (mysqli_query($conn, $sql))
         {
          ...
          {
          $message= "Save_teacher_training" . $sql . "<br>" . mysqli_error($conn);
		  $mobileno="9851001482";
