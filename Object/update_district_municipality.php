...
//echo "Records Saved";
if($mv=="" and $up=="" and $mobile=="" and $upass=="")
{
...
else
{
     //$sql = "Update tbldistrict set districtname='$dn', munvdc='$mv', noofward='$wn',aperson='$person', mobileno='$mobile',mpass='$up' where ID='$id'";
	  $sql = "Update tbldistrict set munvdc='$mv', noofward='$wn',aperson='$person', mobileno='$mobile',mpass='$upass',email='$email' where ID='$id'";
