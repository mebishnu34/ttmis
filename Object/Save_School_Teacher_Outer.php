...
{
 $sql1 = "SELECT * FROM tblteacher where teachercode='$tid'";
 $result = $conn->query($sql1);
   ...
   // while($row = $result->fetch_assoc()) {
     //   echo "id: " . $row["id"]. " - Name: " . $row["firstname"]. " " . $row["lastname"]. "<br>";
          ...
          $sql = "UPDATE tblteacher set tname='$tname', gender='$gender', cast='$cast',mothertong='$tong',subject='$apsubject',loginname='$tid', tpass='$tid',dob='$dob',fathername='$fname', address='$a', email='$email',district='$d', munvdc='$vdc', wardno='$ward',tcontact='$tc', appointdate='$adate', appointtype='$atype',workinglevel='$level', schoolcode='$scode',teachercode='$tid',category='Teacher',teachinglevel='$tlevel', qualification='$qualification', faculty='$faculty', majorsubject='$msubject', teachingsubject='$tsubject', remark='Approved' where teachercode='$tid'";
...
{
header('Location: ../index.php?msg= "Invalid School Code"');
}
}
mysqli_close($conn);
?>
