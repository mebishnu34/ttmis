...
else
{
   ...
   if ($result2->num_rows > 0)
	...
	$sql3="Select * from tblttrainingrequest where trainingid='$traid' and teacherid='$_SESSION[tid]'";
	$result3=$conn->query($sql3);
	if($result3->num_rows>0)
		{
		$sql = "Update tblttrainingrequest set gnumber='$groupno', coordinator='$coordinator', mobileno='$mobile', sdate='$sdate', edate='$edate', remark='Request', duration='$days',division='$div', organization='$venue' where trainingid='$traid' and teacherid='$_SESSION[tid]'";
