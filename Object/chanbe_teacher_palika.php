   ...
   // while($row = $result->fetch_assoc()) {
     //   echo "id: " . $row["id"]. " - Name: " . $row["firstname"]. " " . $row["lastname"]. "<br>";
           ...
           $sql = "UPDATE tblregrequest set tname='$tname', gender='$gender',upass='$up',dob='$dob', address='$a', email='$email',district='$d', munvdc='$vdc', wardno='$ward',tcontact='$tc', appointdate='$adate', appointtype='$atype',workinglevel='$level', schoolcode='$scode',category='Teacher',teachinglevel='$tlevel', qualification='$qualification', faculty='$faculty', majorsubject='$msubject', teachingsubject='$tsubject', remark='Request' where teachercode='$tcode'";
			 ...
			 $sql = "UPDATE tblteacher set tname='$tname', gender='$gender',cast='$cast',mothertong='$mothertong',stream='$stream',fathername='$fathername', dob='$dob', address='$a', email='$email', wardno='$ward',tcontact='$tc', appointdate='$adate', appointtype='$atype',workinglevel='$level',subject='$apsubject', scode='$scode',category='Teacher',teachinglevel='$tlevel', qualification='$qualification', faculty='$faculty', majorsubject='$msubject', teachingsubject='$tsubject' where teacherid='$tid'";
