...
<form method="Post" Action="Object/save_te_training.php">
    <table  cellpadding="5">
           <tr>
    ...
    <td><div id="txtHint">Subject</div>
		   ...
		   <tr>
               ...
               <td><input type="text" name="txtgnumber" size="5" class="normaltext"></td>
           </tr>
               <tr>
               <td align="right">Co-Ordinator</td>
               <td><input type="text" name="txtcoordinator" size="60" class="normaltext"></td>
           </tr>
		   <tr>
		   ...
		   <tr>
               ...
               <td><input type="text" name="txtdivision" size="40" class="normaltext"></td>
           </tr> 
           <tr>
               <td colspan="2" align="center"><input type="submit" value="Save" name="btnupdate" class="button"></td>
           </tr>
    </table>
</form>
</BODY>
