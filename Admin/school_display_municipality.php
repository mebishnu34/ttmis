...
<table class="table_design" cellpadding="2">
<tr>
<th>S.No</th>
...
if ($result->num_rows > 0)
   ...
   echo "<td>". $row["schoolname"] . "</td>";
    ...
    echo "<td><a href=../school/school_details.php?tid=$row[ID] target=_blank>Details</a></td>";
    echo "<td bgcolor=blue><a href=../Input/school_update.php?scode=$row[ID] target=_blank>Edit</a>&nbsp;&nbsp;&nbsp;<a href=../Input/school_update_1.php?scode=$row[ID] target=_blank>Name Edit</a></td>";
    $sn++;
    }
 }
}
